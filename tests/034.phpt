...
var_dump(FFI::sizeof(FFI::type($p1)), FFI::sizeof(FFI::type($p2)), FFI::sizeof(FFI::type($p3)));
var_dump(FFI::alignof(FFI::type($p1)), FFI::alignof(FFI::type($p2)), FFI::alignof(FFI::type($p3)));
?>
--EXPECT--
int(2)
int(4)
